...
// 메뉴(타이틀/정산/육성/엔딩)는 React. Phaser는 캔버스 씬만: Battle + 병렬 HeroPanel.
// 상단 HUD(시청자수/위험도/골드/시점버튼)는 React InfoLayer(ui/InfoLayer.tsx, 2026-07-31 이관).
...
export function createGame(parent: HTMLElement) {
  return new Phaser.Game({
    ...
    scene: [BootScene, BattleScene, HeroPanelScene],
  });
}
