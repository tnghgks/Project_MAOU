...
export const MONSTERS = {
  ...
  archer: { name: '고블린 궁수', hp: 15,  dmg: 4,  atkCd: 2.0, speed: 70,  range: 240, gold: 8,  size: 15, unlock: 1, ranged: true },
  ...
  boss_golem:  { name: '고대 골렘 왕', hp: 600,  dmg: 12, atkCd: 1.6, speed: 30, range: 40, gold: 300,  size: 48, unlock: 99, tint: 0xff8844 },
  boss_knight: { name: '흑기사단장',   hp: 1400, dmg: 18, atkCd: 1.5, speed: 34, range: 44, gold: 800,  size: 52, unlock: 99, tint: 0x8888ff },
  boss_maou:   { name: '마왕',         hp: 2600, dmg: 24, atkCd: 1.4, speed: 38, range: 46, gold: 2000, size: 56, unlock: 99, char: 'grimhardt' },
