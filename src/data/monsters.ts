...
export const MONSTERS = {
  slime:  { name: '슬라임',      hp: 20,  dmg: 3,  atkCd: 1.0, speed: 60,  range: 24,  gold: 8,  size: 16, unlock: 1, cost: 1, role: 'swarm',  char: 'slime', sheet: 32, kb: 1.6 },
  archer: { name: '고블린 궁수', hp: 15,  dmg: 4,  atkCd: 2.0, speed: 70,  range: 240, gold: 12,  size: 15, unlock: 1, cost: 2, role: 'ranged', ranged: true, char: 'goblinarcher', kb: 1 },
  golem:  { name: '사이클롭스',        hp: 120, dmg: 8,  atkCd: 1.5, speed: 35,  range: 30,  gold: 30, size: 26, unlock: 1, cost: 5, role: 'tank',   kb: 0.3, char: 'cyclops', scale: 1.5 },
  bat:    { name: '폭탄 박쥐',   hp: 10,  dmg: 20, atkCd: 0.1, speed: 120, range: 22,  gold: 18, size: 14, unlock: 2, cost: 3, role: 'bomber', suicide: true, char: 'bombbat', sheet: 64, kb: 1.2 },
  knight: { name: '정예 기사',   hp: 300, dmg: 15, atkCd: 1.2, speed: 45,  range: 34,  gold: 90, size: 28, unlock: 3, cost: 8, role: 'tank',   kb: 0.15, char: 'blackknight'},
  ...
  splitter: { name: '분열 슬라임',   hp: 34, dmg: 4,  atkCd: 1.2, speed: 55, range: 24,  gold: 14,  size: 16, unlock: 1, cost: 3, role: 'splitter', char: 'slime', sheet: 32, scale: 1.5, tint: 0xffaa66, kb: 1.4, split: { into: 'slime', count: 2 } },
  // turtle: 느리고 안 죽는 벽. armor 5라 용사 초기 공격력(10)으론 절반밖에 안 박힌다 — 데미지 강화의 존재 이유.
  turtle:   { name: '바위 거북',     hp: 90, dmg: 6,  atkCd: 1.8, speed: 22, range: 26,  gold: 24, size: 24, unlock: 1, cost: 4, role: 'tank',   char: 'rockyturtle', kb: 0.2, armor: 5 },
  // shaman: 자체 전투력은 종잇장인데 주변을 강하게 만든다 — 용사가 "누구부터 자를지" 판단하게 만드는 역할.
  // scale 0.8: 아트 원본 84px인데 같은 고블린인 궁수(64px)보다 커 보이면 안 된다.
  shaman:   { name: '고블린 주술사', hp: 40, dmg: 5,  atkCd: 2.2, speed: 55, range: 180, gold: 33, size: 16, unlock: 2, cost: 5, role: 'buffer', ranged: true, char: 'goblinshaman', scale: 0.8, kb: 1, aura: { radius: 160, atk: 1.35, speed: 1.25 } },
  // sniper: 화면 반대편에서 아프게 때린다. 무시하면 계속 맞고, 끊으러 가면 다른 몹에게 등을 내준다.
  sniper:   { name: '저격 고블린',   hp: 18, dmg: 16, atkCd: 4.0, speed: 45, range: 520, gold: 27, size: 15, unlock: 2, cost: 4, role: 'ranged', ranged: true, char: 'goblinarcher', tint: 0x66ddaa, scale: 1.1, kb: 1.1 },
  ...
  imp:      { name: '임프',          hp: 22, dmg: 5,  atkCd: 0.9, speed: 100, range: 26, gold: 15, size: 14, unlock: 1, cost: 2, role: 'swarm',  char: 'imp', kb: 1.5 },
  // zombie: 거북(armor)과 달리 순수 체력 덩어리 — 다타로도 뚫리지만 그동안 시간이 간다.
  // scale 0.8: 아트 원본 96px, 용사(92px)보다 커 보이면 잡몹으로 안 읽힌다.
  zombie:   { name: '좀비',          hp: 60, dmg: 7,  atkCd: 1.6, speed: 28,  range: 28, gold: 21, size: 20, unlock: 2, cost: 3, role: 'swarm',  char: 'zombie', scale: 0.8, kb: 0.5 },
