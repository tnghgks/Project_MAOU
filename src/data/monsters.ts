...
export const MONSTERS = {
  ...
  boss_golem:  { name: '고대 골렘 왕', hp: 600,  dmg: 12, atkCd: 1.6, speed: 30, range: 40, gold: 300,  size: 92, unlock: 99, char: 'stonegolem', scale: 2,   kb: 0 },
  boss_knight: { name: '흑기사단장',   hp: 1400, dmg: 18, atkCd: 1.5, speed: 34, range: 44, gold: 800,  size: 64, unlock: 99, char: 'blackknight', scale: 1.7, kb: 0 },
  boss_maou:   { name: '마왕',         hp: 2600, dmg: 24, atkCd: 1.4, speed: 38, range: 46, gold: 2000, size: 64, unlock: 99, char: 'grimhardt', scale: 1.2, kb: 0 },
